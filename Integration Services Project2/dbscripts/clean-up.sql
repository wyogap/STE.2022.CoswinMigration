...
DELETE FROM MAXIMO.MRCOST WHERE ste_migrationid is null;
DELETE FROM MAXIMO.MRSTATUS WHERE ste_migrationid is null;
DELETE FROM MAXIMO.INVUSELINESPLIT WHERE ste_migrationid is null;
DELETE FROM MAXIMO.INVUSESTATUS WHERE ste_migrationid is null;
...
DELETE FROM MAXIMO.ITEMSTATUS WHERE ste_migrationid is null;
DELETE FROM MAXIMO.ITEMORGSTATUS WHERE ste_migrationid is null;
...
-- delete migrated glcomponent and glaccount
