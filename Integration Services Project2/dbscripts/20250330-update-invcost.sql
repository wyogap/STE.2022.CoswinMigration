CREATE TABLE "MIGRATION"."BAK_20250330_INVCOST"  (
...
ALTER TABLE MIGRATION.BAK_20250330_INVCOST ADD CREATED_ON TIMESTAMP NOT NULL DEFAULT current_timestamp;

INSERT INTO MIGRATION.BAK_20250330_INVCOST (
