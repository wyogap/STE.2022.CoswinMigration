...
CREATE TABLE "MIGRATION"."T_LD_WORKORDER"  (
		  "ID" BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (  
		    START WITH +1  
		    INCREMENT BY +1  
		    MINVALUE +1  
		    ...
		    CACHE 20  
		    NO ORDER ) , 
		  "PK_WIP_WO" BIGINT NOT NULL , 
		  "WO_WOID" VARCHAR(10 OCTETS),
		  "WO_EQCD" VARCHAR(100 OCTETS),
		  "PK_WIP_WN" BIGINT,
...
ALTER TABLE MIGRATION.T_LD_WORKORDER ADD CONSTRAINT T_LD_WORKORDER_UNIQUE UNIQUE (ID);
CREATE UNIQUE INDEX T_LD_WORKORDER_ID_IDX ON MIGRATION.T_LD_WORKORDER (ID);
CREATE INDEX T_LD_WORKORDER_WO_WOID_IDX ON MIGRATION.T_LD_WORKORDER (WO_WOID);

CREATE TABLE "MIGRATION"."T_LD_SR"  (
		  "ID" BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (  
		    START WITH +1  
		    INCREMENT BY +1  
		    MINVALUE +1  
		    ...
		    CACHE 20  
		    NO ORDER ) , 
		  "PK_EQP_JOBR" BIGINT NOT NULL , 
		  "JR_REF_NO" VARCHAR(10 OCTETS),
		  "JR_EQCD" VARCHAR(100 OCTETS),
		  "PK_JOB_ACTV" BIGINT,
...
ALTER TABLE MIGRATION.T_LD_SR ADD CONSTRAINT T_LD_SR_UNIQUE UNIQUE (ID);
CREATE UNIQUE INDEX T_LD_SR_ID_IDX ON MIGRATION.T_LD_SR (ID);
CREATE INDEX T_LD_SR_JR_REF_NO_IDX ON MIGRATION.T_LD_SR (JR_REF_NO);

CREATE TABLE "MIGRATION"."T_LD_RFQLINE"  (
		  "ID" BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (  
		    START WITH +1  
		    INCREMENT BY +1  
		    MINVALUE +1  
		    ...
		    CACHE 20  
		    NO ORDER ) , 
		  "PK_DEVIS" BIGINT NOT NULL , 
		  "PK_DEVIS_ITEMS" BIGINT,
		  "DEVIS_CD" VARCHAR(25 OCTETS),
		  "PK_DV_RMK" BIGINT,
		  "RFQNUM" VARCHAR(16 OCTETS),
		  "RFQID" BIGINT,
		  "RFQLINENUM" INTEGER,
		  "RFQLINEID" BIGINT,
...
ALTER TABLE MIGRATION.T_LD_RFQLINE ADD CONSTRAINT T_LD_RFQLINE_UNIQUE UNIQUE (ID);
CREATE UNIQUE INDEX T_LD_RFQLINE_ID_IDX ON MIGRATION.T_LD_RFQLINE (ID);
CREATE INDEX T_LD_RFQLINE_DEVIS_CD_IDX ON MIGRATION.T_LD_RFQLINE (DEVIS_CD);
CREATE INDEX T_LD_RFQLINE_PK_DEVIS_ITEMS_IDX ON MIGRATION.T_LD_RFQLINE (PK_DEVIS_ITEMS);
