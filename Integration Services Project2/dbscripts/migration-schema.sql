...
-- SBST DEBUGGING
CREATE TABLE "MIGRATION"."STE_DEBUG"  (
		  "ID" BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (  
		    START WITH +1  
		    INCREMENT BY +1  
		    MINVALUE +1  
...
BEGIN
	...
	SET V_SQL = 'SELECT ISNULL(MAX(' ||P_COLNAME|| '),0)+1 AS MAXID FROM ' ||P_TABLENAME;
	...
	SET V_SQL = 'ALTER SEQUENCE ' ||P_SEQNAME|| ' RESTART WITH ' ||V_MAXID;
