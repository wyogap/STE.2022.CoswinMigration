...
CREATE TABLE "MIGRATION"."SBST_LOCATION_HIER_DEPOT"  (
		  ...
		  "ABBV" VARCHAR(100 OCTETS),
		  "LOCATION_DESC" VARCHAR(100 OCTETS),
		  "BUILDING" VARCHAR(100 OCTETS),
		  "BUILDING_ABBV" VARCHAR(100 OCTETS),
		  "LEVEL" VARCHAR(100 OCTETS),
		  "AREA_CODE" VARCHAR(100 OCTETS),
		  "AREA_DESC" VARCHAR(100 OCTETS),
...
CREATE TABLE "MIGRATION"."SBST_LOCATION_HIER_DEPOT_TRACK"  (
		  "ID" BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (  
		    ...
		    NO ORDER ) , 
		  "TYPE" VARCHAR(100 OCTETS),	
		  "DEPOT" VARCHAR(100 OCTETS),
		  "LOCATION_DESC" VARCHAR(100 OCTETS),
		  "TRACK_CODE" VARCHAR(100 OCTETS),
		  "TRACK_DESC" VARCHAR(100 OCTETS),
		  "LOCATION_FULL_DESC" VARCHAR(250 OCTETS)
	)   
 IN "USERSPACE1"  
 ORGANIZE BY ROW;
...
CREATE TABLE "MIGRATION"."SBST_LOCATION_HIER_TUNNEL"  (
		  "ID" BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (  
		    ...
		    NO ORDER ) , 
		  "TYPE" VARCHAR(100 OCTETS),	
		  "TUNNEL" VARCHAR(100 OCTETS),
		  "LOCATION_DESC" VARCHAR(100 OCTETS),
		  "TRACK_CODE" VARCHAR(100 OCTETS),
		  "TRACKBOUND_CODE" VARCHAR(100 OCTETS),
		  "TRACK_NO" VARCHAR(100 OCTETS),
		  "LOCATION_FULL_DESC" VARCHAR(250 OCTETS)
	)   
 IN "USERSPACE1"  
 ORGANIZE BY ROW;
...
CREATE TABLE "MIGRATION"."SBST_LOCATION_HIER_RTV_VEH"  (
		  "ID" BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (  
		    ...
		    NO ORDER ) , 
		  "TYPE" VARCHAR(100 OCTETS),	
		  "TRAIN" VARCHAR(100 OCTETS),
		  "CAR_TYPE" VARCHAR(100 OCTETS),
		  "TRAIN_CAR" VARCHAR(100 OCTETS),
		  "TRAIN_CAR_DESC" VARCHAR(100 OCTETS),
		  "TRAIN_AREA" VARCHAR(100 OCTETS),
		  "TRAIN_AREA_DESC" VARCHAR(100 OCTETS),
		  "TRAIN_SUBAREA" VARCHAR(100 OCTETS),
		  "TRAIN_SUBAREA_DESC" VARCHAR(100 OCTETS),
		  "LOCATION_FULL_DESC" VARCHAR(250 OCTETS)
	)   
 IN "USERSPACE1"  
 ORGANIZE BY ROW;
...
CREATE TABLE "MIGRATION"."SBST_LOCATION_HIER_VIADUCT"  (
		  "ID" BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (  
		    ...
		    CACHE 20  
		    NO ORDER ) , 
		  "VIADUCT" VARCHAR(100 OCTETS),	
		  "VIADUCT_DESC" VARCHAR(100 OCTETS),
		  "TRACKBOUND_TYPE" VARCHAR(100 OCTETS),
