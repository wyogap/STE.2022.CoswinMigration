...
CREATE TABLE IF NOT EXISTS "MIGRATION"."PATCH_20251231_ITEM_CATALOG"  (
  "ID" BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY (  
    START WITH +1  
    INCREMENT BY +1  
    MINVALUE +1  
...
CREATE TABLE IF NOT EXISTS "MIGRATION"."BAK_20251231_ITEM_CATALOG"  (
	  "ID" BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY (  
	    START WITH +1  
	    INCREMENT BY +1  
	    MINVALUE +1  
...
CREATE TABLE IF NOT EXISTS "MIGRATION"."BAK_20251231_ITEM_CATALOG_DUPLICATE"  (
	  "ID" BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY (  
	    START WITH +1  
	    INCREMENT BY +1  
	    MINVALUE +1  
