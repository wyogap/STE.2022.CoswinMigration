CALL MIGRATION.STE_START_PATCH('20250711-01-REPORT');

-- MAXIMO.STE_RPT_PO_LIST source
...
-- data clean up
UPDATE MAXIMO.rfqvendor SET replieddate=NULL WHERE replieddate<'1900-01-01';

CALL MIGRATION.STE_FINISH_PATCH('20250711-01-REPORT');