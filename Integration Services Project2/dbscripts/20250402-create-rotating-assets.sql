DROP TABLE "MIGRATION"."BAK_20250402_ROTATING_ASSETS" IF EXISTS;
CREATE TABLE "MIGRATION"."BAK_20250402_ROTATING_ASSETS"  (
...
-- GET WHAT TO CREATE
INSERT INTO "MIGRATION"."BAK_20250402_ROTATING_ASSETS" (
