...
--DROP TABLE "MIGRATION"."CSWN_ITEM_DESCRIPTION" IF exists;
--CREATE TABLE "MIGRATION"."CSWN_ITEM_DESCRIPTION"  (
--		  "PK_ITEM" BIGINT NOT NULL , 
--		  "DESCRIPTION" VARCHAR(200 OCTETS) , 
--		  "STE_CSWNITEMNO" VARCHAR(30 OCTETS) NOT NULL )   
--		 ORGANIZE BY ROW;
--
--DROP TABLE "MIGRATION"."CSWN_NSITEM_DESCRIPTION" IF exists;
--CREATE TABLE "MIGRATION"."CSWN_NSITEM_DESCRIPTION"  (
...
-- 
-- BRING TABLE MIGRATION.CSWN_ITEM_DESCRIPTION FROM ON-PREM
-- BRING TABLE MIGRATION.CSWN_NSITEM_DESCRIPTION FROM ON-PREM
-- 
...
FROM MIGRATION.CSWN_ITEM_DESCRIPTION A
...
SELECT B.ITEMID, B.ITEMNUM, B.DESCRIPTION, A.DESCRIPTION AS NEW_DESCRIPTION
FROM MIGRATION.CSWN_NSITEM_DESCRIPTION A
