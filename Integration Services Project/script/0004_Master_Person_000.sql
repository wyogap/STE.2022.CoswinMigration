...
-- Add custom columns
-- ------------------
IF COLUMNPROPERTY(OBJECT_ID('dbo.PERSON'), 'STE_MIGRATIONID', 'ColumnId') IS NULL
ALTER TABLE PERSON
...
BEGIN
	...
	--ALTER TABLE person
	--ADD _PERSONUID bigint IDENTITY;
...
BEGIN
	...
	--update PERSON set PERSONUID = _PERSONUID;

	--alter table PERSON drop column _PERSONUID;
