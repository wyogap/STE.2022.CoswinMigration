...
drop procedure if exists ste_0602_LD_Asset_pre
GO

CREATE PROCEDURE ste_0602_LD_Asset_pre 
	@PackageLogID INT
AS
BEGIN
	-- truncate existing data
	delete from longdescription where STE_MIGRATIONID is not null and ldownertable='ASSET';
...
drop procedure if exists ste_0602_LD_Asset_post
GO

CREATE PROCEDURE ste_0602_LD_Asset_post
  @PackageLogID INT
AS
BEGIN
	...
	where STE_MIGRATIONID is not null and ldownertable='ASSET';
