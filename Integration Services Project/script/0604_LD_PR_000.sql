...
drop procedure if exists ste_0604_LD_PR_pre
GO

CREATE PROCEDURE ste_0604_LD_PR_pre 
	@PackageLogID INT
AS
BEGIN
	-- truncate existing data
	delete from longdescription where STE_MIGRATIONID is not null and ldownertable='PR';
...
drop procedure if exists ste_0604_LD_PR_post
GO

CREATE PROCEDURE ste_0604_LD_PR_post
  @PackageLogID INT
AS
BEGIN
	...
	where STE_MIGRATIONID is not null and ldownertable='PR';
