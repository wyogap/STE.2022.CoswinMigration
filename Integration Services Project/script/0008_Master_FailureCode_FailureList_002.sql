...
drop procedure if exists ste_0008_master_failurecode_pre;
GO

CREATE PROCEDURE ste_0008_master_failurecode_pre 
	@PackageLogID INT
AS
BEGIN
...
drop procedure if exists ste_0008_master_failurelist_pre;
GO

CREATE PROCEDURE ste_0008_master_failurelist_pre 
	@PackageLogID INT
AS
BEGIN
	-- truncate existing data
