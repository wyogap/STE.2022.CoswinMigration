...
-- Add custom columns
-- ------------------
IF COLUMNPROPERTY(OBJECT_ID('dbo.invoiceline'), 'STE_MIGRATIONITEMPK', 'ColumnId') is null
...
BEGIN
	...
	select @v_cnt=count(STE_MIGRATIONID) from invoiceline
