...
drop procedure if exists ste_0608_LD_RFQ_pre
GO

CREATE PROCEDURE ste_0608_LD_RFQ_pre 
	@PackageLogID INT
AS
BEGIN
	-- truncate existing data
	delete from longdescription where STE_MIGRATIONID is not null and ldownertable='RFQ';
...
drop procedure if exists ste_0608_LD_RFQ_post
GO

CREATE PROCEDURE ste_0608_LD_RFQ_post
  @PackageLogID INT
AS
BEGIN
...
drop procedure if exists ste_0608_LD_RFQLine_pre
GO

CREATE PROCEDURE ste_0608_LD_RFQLine_pre 
	@PackageLogID INT
AS
BEGIN
	-- truncate existing data
	delete from longdescription where STE_MIGRATIONID is not null and ldownertable='RFQLine';
...
drop procedure if exists ste_0608_LD_RFQLine_post
GO

CREATE PROCEDURE ste_0608_LD_RFQLine_post
  @PackageLogID INT
AS
BEGIN
	declare @v_start_id int;
