...
-- Add custom columns
-- ------------------
IF COLUMNPROPERTY(OBJECT_ID('dbo.commodities'), 'STE_MIGRATIONID', 'ColumnId') is null
...
drop procedure if exists ste_0022_master_commodities_pre
GO

CREATE PROCEDURE ste_0022_master_commodities_pre 
	@PackageLogID INT
AS
BEGIN
	-- truncate existing data
	delete from commodities where STE_MIGRATIONID is not null;
