...
-- Add custom columns
-- ------------------
IF COLUMNPROPERTY(OBJECT_ID('dbo.matrectrans'), 'STE_MIGRATIONID', 'ColumnId') is null
...
--ALTER TABLE matrectrans
--ADD STE_CSWNINSPREF varchar(10) default null,
--	STE_CSWNINSPDATE datetime default null,
--	STE_CSWNINSPSTAT smallint default null,
--	STE_CSWNGRNREF varchar(10) default null
--;
...
drop procedure if exists ste_0308_po_matrectrans_pre
GO

CREATE PROCEDURE ste_0308_po_matrectrans_pre 
	@PackageLogID INT
AS
BEGIN
	-- truncate existing data
	delete from dbo.matrectrans where STE_MIGRATIONID is not null;
