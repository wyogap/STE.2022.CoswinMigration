...
drop procedure if exists ste_0014_master_persongroup_pre
GO

CREATE PROCEDURE ste_0014_master_persongroup_pre 
	@PackageLogID INT
AS
BEGIN
	-- truncate existing data
	delete from persongroup where STE_MIGRATIONID is not null;
