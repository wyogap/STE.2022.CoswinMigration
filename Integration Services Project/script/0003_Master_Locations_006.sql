...
drop procedure if exists ste_0003_master_locations_pre
GO

CREATE PROCEDURE ste_0003_master_locations_pre 
	@PackageLogID INT
AS
BEGIN
...
drop procedure if exists ste_0003_master_locations_post;
GO

CREATE PROCEDURE ste_0003_master_locations_post
  @PackageLogID INT
AS
BEGIN
