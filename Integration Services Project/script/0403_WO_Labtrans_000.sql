...
-- Add custom columns
-- ------------------
IF COLUMNPROPERTY(OBJECT_ID('dbo.labtrans'), 'STE_MIGRATIONID', 'ColumnId') is null
ALTER TABLE labtrans
ADD STE_MIGRATIONID bigint default null,
    STE_MIGRATIONDATE datetime NOT NULL DEFAULT (GETDATE());

IF COLUMNPROPERTY(OBJECT_ID('dbo.labtrans'), 'STE_MIGRATIONTYPE', 'ColumnId') is null
ALTER TABLE labtrans
ADD STE_MIGRATIONTYPE VARCHAR(16) default null;

IF COLUMNPROPERTY(OBJECT_ID('dbo.labtrans'), 'STE_MIGRATIONEQLEVL', 'ColumnId') is null
ALTER TABLE labtrans
