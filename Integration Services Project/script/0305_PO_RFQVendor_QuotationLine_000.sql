...
-- Add custom columns
-- ------------------
IF COLUMNPROPERTY(OBJECT_ID('dbo.rfqvendor'), 'STE_MIGRATIONID', 'ColumnId') is null
...
-- Add custom columns
-- ------------------
IF COLUMNPROPERTY(OBJECT_ID('dbo.quotationline'), 'STE_MIGRATIONID', 'ColumnId') is null
