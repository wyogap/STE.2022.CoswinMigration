...
drop procedure if exists ste_0603_LD_Contract_pre
GO

CREATE PROCEDURE ste_0603_LD_Contract_pre 
	@PackageLogID INT
AS
BEGIN
	-- truncate existing data
	delete from longdescription where STE_MIGRATIONID is not null and ldownertable='CONTRACT';
...
drop procedure if exists ste_0603_LD_Contract_post
GO

CREATE PROCEDURE ste_0603_LD_Contract_post
  @PackageLogID INT
AS
BEGIN
	...
	where STE_MIGRATIONID is not null and ldownertable='CONTRACT';
